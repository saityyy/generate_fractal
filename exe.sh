...
python3 ./fractal_renderer/make_fractaldb.py --draw_type="point_gray" --save_root="./data/function/DB/FractalDB_funcnum1" --load_root="./data/function/f1/csv"   --instance=${instance_num}
python3 ./fractal_renderer/make_fractaldb.py --draw_type="point_gray" --save_root="./data/function/DB/FractalDB_funcnum4" --load_root="./data/function/f4/csv"   --instance=${instance_num}
python3 ./fractal_renderer/make_fractaldb.py --draw_type="point_gray" --save_root="./data/function/DB/FractalDB_funcnum8" --load_root="./data/function/f8/csv"   --instance=${instance_num}
python3 ./fractal_renderer/make_fractaldb.py --draw_type="point_gray" --save_root="./data/function/DB/FractalDB_allfunc"  --load_root="./data/function/fall/csv" --instance=${instance_num}
