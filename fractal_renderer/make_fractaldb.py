...
def conf():
    ...
    parser.add_argument('--load_root', default='./data/csv', type=str, help='load csv root')
    parser.add_argument('--save_root', default='./data/FractalDB', type=str, help='save png root')
    parser.add_argument('--image_size_x', default=224, type=int, help='image size x')
    parser.add_argument('--image_size_y', default=224, type=int, help='image size y')
